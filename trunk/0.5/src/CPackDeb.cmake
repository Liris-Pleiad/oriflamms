...
IF(CPACK_DEBIAN_PACKAGE_SHLIBDEPS)
  ...
  IF(SHLIBDEPS_EXECUTABLE)
    ...
    string (REGEX REPLACE "^.*Depends=" "" CPACK_DEBIAN_PACKAGE_AUTO_DEPENDS "${SHLIBDEPS_OUTPUT}") # libcrn patch
    ...
    # Append user depend if set
		if(NOT "${CPACK_DEBIAN_PACKAGE_AUTO_DEPENDS}" STREQUAL "") # libcrn patch
